...
var require_telegram_web_apps = /* @__PURE__ */ __commonJS({ "node_modules/@twa-dev/sdk/dist/telegram-web-apps.js": (() => {
	(function() {
		var eventHandlers = {};
		var locationHash = "";
		try {
		...
		function urlParseHashParams(locationHash$1) {
			locationHash$1 = locationHash$1.replace(/^#/, "");
			var params = {};
			if (!locationHash$1.length) return params;
			if (locationHash$1.indexOf("=") < 0 && locationHash$1.indexOf("?") < 0) {
				params._path = urlSafeDecode(locationHash$1);
				return params;
			}
			var qIndex = locationHash$1.indexOf("?");
			if (qIndex >= 0) {
				var pathParam = locationHash$1.substr(0, qIndex);
				params._path = urlSafeDecode(pathParam);
				locationHash$1 = locationHash$1.substr(qIndex + 1);
			}
			var query_params = urlParseQueryString(locationHash$1);
		...
		function urlAppendHashParams(url$1, addHash) {
			var ind = url$1.indexOf("#");
			if (ind < 0) return url$1 + "#" + addHash;
			var curHash = url$1.substr(ind + 1);
			if (curHash.indexOf("=") >= 0 || curHash.indexOf("?") >= 0) return url$1 + "&" + addHash;
			if (curHash.length > 0) return url$1 + "?" + addHash;
			return url$1 + addHash;
		}
		...
		function sessionStorageSet(key$1, value) {
			try {
				window.sessionStorage.setItem("__telegram__" + key$1, JSON.stringify(value));
				return true;
			} catch (e) {}
			return false;
		}
		function sessionStorageGet(key$1) {
			try {
				return JSON.parse(window.sessionStorage.getItem("__telegram__" + key$1));
			} catch (e) {}
			return null;
		}
	...
	(function() {
		...
		function setThemeParams(theme_params$1) {
			if (theme_params$1.bg_color == "#1c1c1d" && theme_params$1.bg_color == theme_params$1.secondary_bg_color) theme_params$1.secondary_bg_color = "#2c2c2e";
			var color;
			for (var key$1 in theme_params$1) if (color = parseColorToHex(theme_params$1[key$1])) {
				themeParams[key$1] = color;
				if (key$1 == "bg_color") {
					colorScheme = isColorDark(color) ? "dark" : "light";
					setCssProperty("color-scheme", colorScheme);
				}
				key$1 = "theme-" + key$1.split("_").join("-");
				setCssProperty(key$1, color);
			}
			Utils.sessionStorageSet("themeParams", themeParams);
		}
		function setDefaultColors(def_colors$1) {
			if (colorScheme == "dark") {
				if (def_colors$1.bg_dark_color) webAppBackgroundColor = def_colors$1.bg_dark_color;
				if (def_colors$1.header_dark_color) {
					webAppHeaderColorKey = null;
					webAppHeaderColor = def_colors$1.header_dark_color;
				}
			} else {
				if (def_colors$1.bg_color) webAppBackgroundColor = def_colors$1.bg_color;
				if (def_colors$1.header_color) {
					webAppHeaderColorKey = null;
					webAppHeaderColor = def_colors$1.header_color;
				}
			}
			Utils.sessionStorageSet("defaultColors", def_colors$1);
		}
		var webAppCallbacks = {};
		...
		var BottomButtonConstructor = function(type) {
			...
			Object.defineProperty(bottomButton, "text", {
				set: function(val$1) {
					bottomButton.setParams({ text: val$1 });
				},
				get: function() {
					return buttonText;
				},
			...
			Object.defineProperty(bottomButton, "color", {
				set: function(val$1) {
					bottomButton.setParams({ color: val$1 });
				},
				get: function() {
			...
			Object.defineProperty(bottomButton, "textColor", {
				set: function(val$1) {
					bottomButton.setParams({ text_color: val$1 });
				},
				get: function() {
			...
			Object.defineProperty(bottomButton, "isVisible", {
				set: function(val$1) {
					bottomButton.setParams({ is_visible: val$1 });
				},
				get: function() {
					return isVisible;
				},
			...
			Object.defineProperty(bottomButton, "isActive", {
				set: function(val$1) {
					bottomButton.setParams({ is_active: val$1 });
				},
				get: function() {
					return isActive;
				},
			...
			Object.defineProperty(bottomButton, "hasShineEffect", {
				set: function(val$1) {
					bottomButton.setParams({ has_shine_effect: val$1 });
				},
				get: function() {
			...
			if (!isMainButton) Object.defineProperty(bottomButton, "position", {
				set: function(val$1) {
					bottomButton.setParams({ position: val$1 });
				},
				get: function() {
			...
			if (initParams.tgWebAppDebug) {
				...
				for (var k$1 in debugBtnStyle) debugBtn.style[k$1] = debugBtnStyle[k$1];
		...
		var CloudStorage = (function() {
			...
			cloudStorage.setItem = function(key$1, value, callback) {
				return invokeStorageMethod("saveStorageValue", {
					key: key$1,
					value
				}, callback);
			};
			cloudStorage.getItem = function(key$1, callback) {
				return cloudStorage.getItems([key$1], callback ? function(err, res) {
					if (err) callback(err);
					else callback(null, res[key$1]);
				} : null);
			};
			cloudStorage.getItems = function(keys, callback) {
				return invokeStorageMethod("getStorageValues", { keys }, callback);
			};
			cloudStorage.removeItem = function(key$1, callback) {
				return cloudStorage.removeItems([key$1], callback);
			};
			...
			if (WebAppContactRequested) {
				...
				if (requestSent) getRequestedContact(function(res) {
					if (res && res.length) {
						...
						for (var key$1 in webViewEvent.responseUnsafe) {
							var val$1 = webViewEvent.responseUnsafe[key$1];
							try {
								if (val$1.substr(0, 1) == "{" && val$1.substr(-1) == "}" || val$1.substr(0, 1) == "[" && val$1.substr(-1) == "]") webViewEvent.responseUnsafe[key$1] = JSON.parse(val$1);
							} catch (e) {}
						}
					}
		...
		WebApp.openLink = function(url$1, options) {
			var a = document.createElement("A");
			a.href = url$1;
			if (a.protocol != "http:" && a.protocol != "https:") {
				console.error("[Telegram.WebApp] Url protocol is not supported", url$1);
				throw Error("WebAppTgUrlInvalid");
			}
			var url$1 = a.href;
			options = options || {};
			if (versionAtLeast("6.1")) {
				var req_params = { url: url$1 };
			...
			} else window.open(url$1, "_blank");
		};
		WebApp.openTelegramLink = function(url$1, options) {
			var a = document.createElement("A");
			a.href = url$1;
			if (a.protocol != "http:" && a.protocol != "https:") {
				console.error("[Telegram.WebApp] Url protocol is not supported", url$1);
			...
			if (a.hostname != "t.me") {
				console.error("[Telegram.WebApp] Url host is not supported", url$1);
				throw Error("WebAppTgUrlInvalid");
			}
...
var require_sdk = /* @__PURE__ */ __commonJS({ "node_modules/@twa-dev/sdk/dist/sdk.js": ((exports) => {
...
var require_dist = /* @__PURE__ */ __commonJS({ "node_modules/@twa-dev/sdk/dist/index.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
