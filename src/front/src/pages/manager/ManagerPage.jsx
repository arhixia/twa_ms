...
export default function ManagerPage() {
  ...
  const { 
    fullname, 
    logout: clearAuth,
    managerInvoiceNotIssuedCount,
    updateManagerInvoiceNotIssuedCount
  } = useAuthStore();
  ...
  async function loadTaskCounts() {
    ...
    try {
      await updateManagerInvoiceNotIssuedCount();
    } catch (e) {
  ...
  return (
    <div className="logist-app">
      ...
      <nav className="montajnik-nav">
        <NavLink to="/manager/tasks" className="nav-item">
          ...
          {!loadingCounts && managerInvoiceNotIssuedCount > 0 && (
            <span className="badge">{managerInvoiceNotIssuedCount}</span>
          )}
        </NavLink>
        
        <NavLink to="/manager/me" className="nav-item">
          <div className="nav-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
              <circle cx="12" cy="7" r="4"></circle>
