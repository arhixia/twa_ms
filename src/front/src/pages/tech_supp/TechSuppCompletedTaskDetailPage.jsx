// front/src/pages/tech/TechSuppCompletedTaskDetailPage.jsx
import React, { useState, useEffect } from "react";
import { useParams, useNavigate } from "react-router-dom";
import { techSuppCompletedTaskDetail, getEquipmentList, getWorkTypes } from "../../api"; // Добавляем импорты справочников
import "../../styles/LogistPage.css";

export default function TechSuppCompletedTaskDetailPage() {
  ...
  async function loadTask() {
    ...
    setError(null);
    try {
      const data = await techSuppCompletedTaskDetail(id); // Вызываем новый API метод
      setTask(data);
    } catch (err) {
      console.error("Ошибка загрузки завершенной задачи тех.спеца:", err);
        ...
        <div className="task-detail">
          <div className="task-view">
            ...
            <div className="section">
              ...
              <button className="add-btn" onClick={() => navigate(`/tech_supp/tasks/${task.id}/history`)}>
                Подробнее
              </button>
            </div>
