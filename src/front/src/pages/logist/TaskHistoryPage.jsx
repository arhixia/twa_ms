    ...
    <div className="logist-main">
      <div className="page">
        ...
        <div className="history-list" style={{ 
          ...
          gap: '24px',
          maxHeight: 'none', // Переопределяем max-height для мобильных
          overflowY: 'visible' // Переопределяем overflow для мобильных
        }}>
          {history.map((h) => {
              ...
              return (
                <li key={h.id} className="history-item" style={{ 
                  marginBottom: '0', // Убираем лишний отступ, т.к. используем gap
                  border: '2px solid var(--border-subtle)',
                  borderRadius: '10px',
                  padding: '16px',
                  minHeight: '120px', // Добавляем минимальную высоту
                  display: 'flex',
                  flexDirection: 'column',
                  justifyContent: 'space-between',
                  backgroundColor: 'var(--bg-card)', // Устанавливаем фон из переменной
                }}>
    ...
    <div style={{ marginTop: '12px' }}>
      ...
      {expanded && (
        <div style={{ 
          ...
          <div className="task-section" style={{ gridColumn: '1 / -1' }}> {/* Добавлен стиль для растяжения */}
  <div className="task-section-header">
